...
<template>
  ...
  <canvas v-for="item in canvas_data" :src="item.path" :id="item.id" class="absolute z-40" @mouseleave="canvas_class.get_all_canvas" width="560px" height="322.3px"></canvas>
  <slot name="content">
